...
public class TravelingSalesPerson {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(TravelingSalesPerson.solve(distances));
        ...
        System.out.println(TravelingSalesPerson.solve(distances1));
        ...
        System.out.println(TravelingSalesPerson.solve(distances2));
    }
}